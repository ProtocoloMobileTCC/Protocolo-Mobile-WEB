    ...
    <body>
        ...
        <table name="protocolos" id="protocolos" align="center" border="2px">
			...
			<?php
				...
				$sql = "SELECT * FROM protocolo where usuario_id='{$_GET['nome']}'order by status_id, protocolo_id";
	        ...
	        <tr>
                ...
                <td align="center"><?=$obsProtocolo ?><br/><a href="verobs.php?cod=<?=$codProtocolo?>">
                	<input type="button" id="ver+" nome="ver+" value="  ver+  " /></a></td>
                ...
                <td align="center">
                    <form name="select"  method="post" action="verificaselect.php?cod=<?=$codProtocolo?>">
                        <select id="select" name="select">
                            ...
                            <option value="6">Solicitar Cancelamento</option>
                        </select>
						<?php
                        
                            $ticketP[]=array();
                            $ticketP['titulo']= $tituloProtocolo;
                            $ticketP['descricao'] = $descricaoProtocolo;
                            $ticketP['obs']= $obsProtocolo;
                            $ticketP['local'] =$localizacaoProtocolo;
                            $ticketP['usuario'] = identifica_usuario($usuarioProtocolo);
                            $ticketP['status'] = traduz_status_ticket($statusProtocolo);

...
<html>
    ...
    <body>
        ...
        <h3>Direcionamento Ticket nº <span style="color:#F00"><?= $tkt?></span></h3>
        ...
        <form name="f_direciona_ticket" id="f_direciona_ticket" method="post" action="direcionatkt.php">
            ...
            <label for="sel_direcionamento">Direcionamento: </label>
                <select name="sel_direcionamento" id="sel_direcionamento">
                    ...
                    <option value="1"> Secretaria de Infraestrutura</option>
                    <option value="2">Secretaria de Transportes</option>
                    <option value="3">Secretaria de Segurança</option>
                    <option value="4">Secretaria de Saúde</option>
                    <option value="5">Secretaria de Eduacação</option>
                    <option value="6">Secretaria de Meio Ambiente</option>                  
                </select>
            <br/><br />
